...
public class Item2EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item = (Item2)getIntent().getSerializableExtra("item"); // 복구
    ...
    public void btnSave_clicked(View view) {
        ...
        setResult(Activity.RESULT_OK, intent); // RESULT_OK : 작업완료
    ...
    public void btnCancel_clicked(View view) {
        Intent intent = new Intent();
        setResult(Activity.RESULT_CANCELED, intent); // RESULT_CANCELED : 작업실패
        finish();
    }
}
